...
class RedisSync {
    ...
    set gold(value) {
        ...
        //统计金币变化dfc
        if (value < 0) {
            mission.add(this.id, mission.MissionType.USE_GOLD, 0, Math.abs(value));
        } else if (value > 0) {
            mission.add(this.id, mission.MissionType.GET_GOLD, 0, value);
        }
    ...
    set pearl(value) {
        if (this.pearl - value > 0) {
            mission.add(this.id, mission.MissionType.USE_DIAMOND, 0, this.pearl - value);
        }
