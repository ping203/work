...
async function monthSign(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.monthSign({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async  function get_day_reward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.getDayReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function get_day_extra_reward(data){
    return new Promise(function(resolve,reject){
        buzz_reward.getDayExtraReward({pool:global.mysqlPool},data,function(err,result){
            if(err){
...
async function guideReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.guideReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function dailyReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.dailyReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function achieveReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.achieveReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function missionReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.missionReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function missionInfo(data) {
    return new Promise(function (resolve, reject) {
        buzz_mission.getMission({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function activeReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.activeReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function onekeyReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_reward.onekeyReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function getUserRank(data) {
    return new Promise(function (resolve, reject) {
        buzz_charts.getUserRank({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function getChartReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_charts.getChartReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function getAdReward(data) {
    return new Promise(function (resolve, reject) {
        buzz_gift.getAdReward({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
...
async function getAdRewardTimes(data) {
    return new Promise(function (resolve, reject) {
        buzz_gift.getAdRewardTimes({pool:global.mysqlPool}, data, function (err, result) {
            if (err) {
