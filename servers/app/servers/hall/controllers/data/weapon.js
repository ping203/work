...
async function levelup(data) {
    return new Promise(function (resolve, reject) {
        buzz_weapon.levelup({pool:mysqlPool}, data, function (err, result) {
            if (err) {
...
async function upstar(data) {
    return new Promise(function (resolve, reject) {
        buzz_weapon.upstar({pool:mysqlPool}, data, function (err, result) {
            if (err) {
...
async function buySkin(data) {
    return new Promise(function (resolve, reject) {
        buzz_weapon.buySkin({pool:mysqlPool}, data, function (err, result) {
            if (err) {
...
async function equip(data) {
    return new Promise(function (resolve, reject) {
        buzz_weapon.equip({pool:mysqlPool}, data, function (err, result) {
            if (err) {
...
async function vote(data) {
    return new Promise(function (resolve, reject) {
        buzz_weapon.vote({pool:mysqlPool}, data, function (err, result) {
            if (err) {
...
async function querySkinVote(data) {
    return new Promise(function (resolve, reject) {
        buzz_weapon.querySkinVote({pool:mysqlPool}, data, function (err, result) {
            if (err) {
