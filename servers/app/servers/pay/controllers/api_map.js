...
const DATA_API = {
    ...
    month_card_reward: { flag:30142, desc:"领取月卡奖励", record:1 },
    pack_mix: { flag:30143, desc:"背包合成", record:1 },
    first_recharge_reward: { flag:30144, desc:"首充奖励领取", record:1 },
    pack_sell: { flag:30145, desc:"背包出售", record:1 },
    pack_use: { flag:30146, desc:"背包使用", record:1 },
    
    get_ad_reward: { flag:30241, desc:"获取观看广告的奖励", record:1 },
    get_ad_reward_times: { flag:30242, desc:"获取玩家今日领取观看广告奖励的次数", record:1 },
};
