...
CREATE TABLE `tbl_account` (
  ...
  `tempname` varchar(32) DEFAULT NULL COMMENT '临时账户名，平台前缀_id',
  ...
  PRIMARY KEY (`id`),
  INDEX (`channel_account_id`, `channel_account_name`, `nickname`)
...
CREATE TABLE `tbl_change_log` (
  ...
  `status` int(11) NOT NULL DEFAULT '0' COMMENT '兑换状态(0:处理中,1:发送中,2:成功,3:玩家取消,4:失败,5:禁止操作)',
